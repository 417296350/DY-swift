...
class RecommedNormalCell: RecommedBaseViewCell {

    //MARK: 控件属性 (特有控件 -- 公共控件全部放在父类RecommedBaseViewCell中了)
    @IBOutlet weak var roomNameLabel: UILabel!                //房间名称
